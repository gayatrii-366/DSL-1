...
int main() {
    ...
    do {
        ...
        printf("3. Linear Search (Unsorted/Sorted Data)\n");
        printf("4. Binary Search (Requires Auto-Sorting)\n");
        printf("5. Exit\n");
        ...
        switch (choice) {
            ...
            case 4:
                ...
                printf("\nSorting student records by roll number for binary search...\n");
                sortByRollNumber(s, n);
                display(s, n); // Show updated sorted list
